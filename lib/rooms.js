...
function convertToRestaurantInfo(data) {
  ...
  const restaurantInfo = {
    ...
    price: data.price, // Assuming price information is not available in the provided data
...
function didPlayerVote(lobbyId,playerId){
  return activeRooms[lobbyId].votes.has(playerId)
}
